...
In training phase, we proceed with 12288 spectrogram, learning rate of 1e-4, 10 epcoch and batch size of 32. The number of Trump's voice spectrogram is around 2200. 
...
\begin{figure}[!htb]
  \minipage{0.5\textwidth}
  \includegraphics[width=\linewidth]{figures/ae_target_gan_loss/spectro_original_speech}
  \caption{original singing}
  \endminipage\hfill
  \minipage{0.5\textwidth}
  \includegraphics[width=\linewidth]{figures/ae_target_gan_loss/spectro_reconstruct_speech}
